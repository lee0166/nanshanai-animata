...
import { getItemImagePrompt, getDefaultStylePrompt, DefaultStylePrompt } from '../../../services/prompt';
...
const ItemDetail: React.FC<ItemDetailProps> = ({ asset, onUpdate, projectId }) => {
    ...
    useEffect(() => {
        ...
        if (needsUpdate) {
            console.log(`[ItemDetail] Auto-correcting params for model ${modelId}: Res ${resolution}->${newRes}, Ratio ${aspectRatio}->${newRatio}`);
                ...
                if (job.status === JobStatus.COMPLETED || job.status === JobStatus.FAILED) {
                    ...
                    if (job.status === JobStatus.COMPLETED) {
                        ...
                        try {
                            ...
                            console.log(`[ItemDetail] Reloaded asset ${asset.id}. Generated images count: ${updatedAsset?.generatedImages?.length || 0}`);
    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            console.log(`[ItemDetail] Submitting generation job for asset: ${asset.id} with count: ${generateCount}. MaxBatchSize: ${maxBatchSize}`);
            ...
            <div className="w-[520px] flex-shrink-0 flex flex-col gap-8 overflow-y-auto pr-2 pb-10">
                ...
                <div className="flex flex-col gap-6">
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-slate-300 font-bold text-base ml-1">{t.project.itemTypeLabel}</label>
                            <Select 
