...
import { Button, Card, Breadcrumbs, BreadcrumbItem } from '@heroui/react';
      ...
      <div className="w-full max-w-[1600px] mx-auto h-full flex flex-col min-h-0">
        ...
        <div className="flex-1 min-h-0">
          {activeTab === AssetType.CHARACTER ? (
            ...
            <ResourceManager projectId={projectId || ''} refreshTrigger={0} />
          ) : (
