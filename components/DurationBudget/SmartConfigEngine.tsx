...
export const SmartConfigEngine: React.FC<SmartConfigEngineProps> = ({
  ...
  const generateRecommendation = (): SmartRecommendation => {
    ...
    if (novelLength < 3000) {
      ...
      reason =
        t.settings.durationBudget?.shortTextReason ||
      ...
      reason =
        t.settings.durationBudget?.mediumTextReason ||
      ...
      reason =
        t.settings.durationBudget?.longTextReason ||
            ...
            <div className="mt-3 p-3 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">
                    {getPlatformName(recommendation.recommendedConfig.platform)}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-slate-500">
                  ...
                  <span className="font-medium">
                    {getPaceName(recommendation.recommendedConfig.pace)}
                  </span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="text-slate-500">
              ...
              <div className="mt-3 pt-3 border-t border-slate-200 dark:border-slate-800">
                <div className="flex items-center gap-4 text-xs text-slate-500">
                  ...
                  <span>
                    🎬 {t.settings.durationBudget?.recommendedShots || '推荐分镜'}:{' '}
                    {recommendation.recommendedShots}
                  </span>
                </div>
              </div>
            </div>
