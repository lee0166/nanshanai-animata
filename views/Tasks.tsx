      ...
      <div className="max-w-[1600px] mx-auto w-full flex flex-col h-full gap-6">
        ...
        <div className="flex flex-wrap gap-4 items-center">
          ...
          >
            ...
            <SelectItem key={JobStatus.PENDING} value={JobStatus.PENDING}>
              {t.jobs.waiting}
            </SelectItem>
            <SelectItem key={JobStatus.PROCESSING} value={JobStatus.PROCESSING}>
              {t.jobs.processing}
            </SelectItem>
            <SelectItem key={JobStatus.COMPLETED} value={JobStatus.COMPLETED}>
              {t.character.generationSuccess}
            </SelectItem>
            <SelectItem key={JobStatus.FAILED} value={JobStatus.FAILED}>
              {t.character.generationFailed}
            </SelectItem>
          </Select>
          ...
          >
            ...
            <SelectItem key="generate_image" value="generate_image">
              {t.jobTypes.generate_image}
            </SelectItem>
            <SelectItem key="generate_video" value="generate_video">
              {t.jobTypes.generate_video}
            </SelectItem>
          </Select>
        ...
        <Card className="flex-1 overflow-hidden" shadow="sm" radius="lg">
          ...
          >
            <TableHeader>
              ...
              <TableColumn key="userPrompt" width={250}>
                {t.jobs.userPrompt}
              </TableColumn>
              <TableColumn key="prompt" width={250}>
                {t.jobs.finalPrompt}
              </TableColumn>
                        ...
                        <div>
                          ...
                          <p>
                            {selectedJob.params?.assetType
                              ? t.project[selectedJob.params.assetType as keyof typeof t.project] ||
                                selectedJob.params.assetType
                              : '-'}
                          </p>
                        </div>
