...
import { Card, CardHeader, CardBody, Chip, Button, ScrollShadow, Tooltip } from '@heroui/react';
    ...
    return (
      ...
      >
        <div
          ...
          tabIndex={0}
          onKeyDown={e => {
            if (e.key === 'Enter') setViewMode('expanded');
          }}
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 font-medium">
                  {t.jobs.activeRunning
                    .replace('{active}', String(activeCount))
                    .replace('{running}', String(processingCount))}
                </span>
              </div>
            </div>
          ...
          {displayedJobs.map(job => (
            ...
            >
              ...
              <p
                ...
                title={job.params.userPrompt || job.params.prompt}
              >
