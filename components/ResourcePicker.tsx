      ...
      <ModalContent>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            {!isImageOnly && !isVideoOnly && (
              <Tabs
                ...
                classNames={{
                  tabList:
                    'bg-slate-100 dark:bg-slate-950 p-1 rounded-xl border border-slate-200 dark:border-slate-800',
        ...
        <ModalFooter className="flex justify-between items-center">
          <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">
            {selectedIds.size > 0
              ? `${t.project.selected}: ${selectedIds.size} / ${maxSelect}`
              : t.project.selectResource}
          </p>
