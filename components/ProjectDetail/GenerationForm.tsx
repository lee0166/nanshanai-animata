...
import { Button, Textarea, Select, SelectItem, Card, Chip, Slider } from '@heroui/react';
...
const GenerationForm: React.FC<GenerationFormProps> = ({
  ...
  const capabilities = {
    ...
    minAspectRatio:
      selectedModel?.capabilities?.minAspectRatio ?? staticModel?.capabilities?.minAspectRatio,
    maxAspectRatio:
      selectedModel?.capabilities?.maxAspectRatio ?? staticModel?.capabilities?.maxAspectRatio,
  };
  ...
  const allAspectRatios = ['1:1', '16:9', '9:16', '4:3', '3:4', '3:2', '2:3', '21:9', '9:21'];
  ...
  const aspectRatios = ['1:1', '16:9', '9:16', '4:3', '3:4', '3:2', '2:3', '21:9', '9:21'];
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Button
                    ...
                    aria-label="上传参考图"
                    isDisabled={
                      generating || referenceImages.length >= (capabilities.maxReferenceImages || 1)
                    }
                ...
                <div className="flex flex-wrap gap-2">
                  {referenceImages.map((img, idx) => (
                    <div
                      key={idx}
                      className="relative w-16 h-16 rounded-lg overflow-hidden border border-slate-200 dark:border-slate-800 group"
                    >
